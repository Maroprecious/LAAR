...
import {allUsers} from "../../public/redux/reducers/users/thunkAction"
import { SuspendDrivers, deleteDrivers } from "../../public/redux/reducers/drivers/thunkAction";
...
const Users = () => {
    ...
    const { loading, getAllUsers } = useAppSelector(
                                                                                ...
                                                                                <Tr key={element.id}>
                                                                                    ...
                                                                                    <Td>
                                                                                        <Text
                                                                                            ...
                                                                                            fontFamily='Poppins'
                                                                                        >
                                                                                            {(element.accountNumber) ? (element.accountNumber) : "No account"}
                                                                                        </Text>
                                                                                    </Td>
                                                                                    <Td>
                                                                                        <Text
                                                                                        ...
                                                                                        >
                                                                                           {
                                                                                             (element.phone) ?  (element.phone) : "No phone"
                                                                                           }
                                                                                        </Text>
                                                                                    </Td>
