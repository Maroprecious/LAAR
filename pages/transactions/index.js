...
import { allTransactions } from "../../public/redux/reducers/transactions/thunkAction";
...
const Transactions = () => {
    ...
    const { getAllTransactions, loading } = useAppSelector(
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <Text
                                                ...
                                                fontWeight={400}
                                            >
                                                Your transactions history on LAAR
                                            </Text>
                                        </VStack>

                                        {
                                            getAllTransactions[0]?.length === 0
                                                ?
                                                <Text
                                                    color={text_2}
                                                    textAlign='center'
                                                    ...
                                                    >
                                                        ...
                                                        <TableContainer width='100%' paddingTop='30px'>
                                                            <Table variant='simple'>
                                                                ...
                                                                <Tbody>
                                                                    {
                                                                        paginatedValues?.map((element, id) => {
                                                                            return (
                                                                                <Tr key={element.id}>
                                                                                    <Td>
                                                                                        <Text
                                                                                    ...
                                                                                    <Td>
                                                                                        <Text
                                                                                            ...
                                                                                            fontFamily='Poppins'
                                                                                        >
                                                                                            <CurrencyFormat value={element.amount} displayType={'text'} thousandSeparator={true} prefix={'₦'} renderText={value => <div>{value}</div>} />
                                                                                        </Text>
                                                                                    </Td>
